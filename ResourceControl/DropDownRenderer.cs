...
{
    public class DropDownRenderer : ToolStripProfessionalRenderer
    {
        //field
        ...
        //Constructor
        public DropDownRenderer(bool isMainMenu, Color primaryColor, Color textColor)
            : base(new DropDown(isMainMenu, primaryColor))
        {
